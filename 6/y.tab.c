...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_declaration_list = 12,          /* declaration_list  */
  YYSYMBOL_declaration = 13,               /* declaration  */
  YYSYMBOL_type = 14,                      /* type  */
  YYSYMBOL_var_list = 15                   /* var_list  */
};
...
static const char *const yytname[] =
{
  ...
  "FLOAT", "CHAR", "'\\n'", "';'", "','", "$accept", "program",
  "declaration_list", "declaration", "type", "var_list", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 7: /* type: INT  */
#line 66 "declaration.y"
          { current_type="int"; }
#line 1179 "y.tab.c"
    break;

  case 8: /* type: FLOAT  */
#line 67 "declaration.y"
            { current_type="float"; }
#line 1185 "y.tab.c"
    break;

  case 9: /* type: CHAR  */
#line 68 "declaration.y"
           { current_type="char"; }
#line 1191 "y.tab.c"
    break;

  case 10: /* var_list: IDENTIFIER  */
#line 70 "declaration.y"
                     { addToTable((yyvsp[0].str),current_type); }
#line 1197 "y.tab.c"
    break;

  case 11: /* var_list: var_list ',' IDENTIFIER  */
#line 71 "declaration.y"
                                  { addToTable((yyvsp[0].str),current_type); }
#line 1203 "y.tab.c"
    break;
